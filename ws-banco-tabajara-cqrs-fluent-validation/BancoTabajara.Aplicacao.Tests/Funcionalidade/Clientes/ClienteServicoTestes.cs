...
namespace BancoTabajara.Aplicacao.Tests.Funcionalidade.Clientes
{
    ...
    public class ClienteServicoTestes
    {
        ...
        private ClienteQuery _clienteQuery;
        private ClienteRegistroCommand _clienteRegistroCommand;
        private ClienteAtualizarCommand _clienteAtualizarCommand;
        private ClienteRemoveCommand _clienteRemoveCommand;
        ...
        public void Initialize()
        {
            ...
            _clienteAtualizarCommand = new ClienteAtualizarCommand();
            _clienteRegistroCommand = new ClienteRegistroCommand();
            _clienteRemoveCommand = new ClienteRemoveCommand();
            _clienteQuery = new ClienteQuery();
        }
        ...
        public void Cliente_servico_inserir_deve_funcionar()
        {
            ...
            _clienteRegistroCommand.Cpf = cliente.Cpf;
            _clienteRegistroCommand.DataNascimento = cliente.DataNascimento;
            _clienteRegistroCommand.Nome = cliente.Nome;
            _clienteRegistroCommand.Rg = cliente.Rg;
            
            _clienteRepositorioFake.Setup(pr => pr.Inserir(It.IsAny<Cliente>())).Returns(cliente);

            var novoClienteId = _servico.Inserir(_clienteRegistroCommand);

            _clienteRepositorioFake.Verify(pr => pr.Inserir(It.IsAny<Cliente>()), Times.Once);
        ...
        //    var cliente = ObjectMother.ClienteValido();
        //    cliente.Id = 1;
        //    _clienteQuery.Cpf = cliente.Cpf;
        //    _clienteQuery.DataNascimento = cliente.DataNascimento;
        //    _clienteQuery.Nome = cliente.Nome;
        //    _clienteQuery.Rg = cliente.Rg;
        ...
        public void Cliente_servico_deletar_deve_funcionar()
        {
            ...
            var ClienteDeletado = _servico.Deletar(_clienteRemoveCommand);
        ...
        public void Cliente_servico_deletar_id_nao_encontrado_deve_falhar()
        {
            ...
            Action action = () => _servico.Deletar(_clienteRemoveCommand);
        ...
        public void Cliente_servico_atualizar_deve_funcionar()
        {
            ...
            var ClienteDeletado = _servico.Atualizar(_clienteAtualizarCommand);
        ...
        public void Cliente_servico_atualizar_deve_falhar_por_id_nao_encontrado()
        {
            ...
            Action clienteAction = () => _servico.Atualizar(_clienteAtualizarCommand);
