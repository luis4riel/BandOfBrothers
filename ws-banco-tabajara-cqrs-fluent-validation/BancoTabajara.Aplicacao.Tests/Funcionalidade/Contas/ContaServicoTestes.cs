...
namespace BancoTabajara.Aplicacao.Tests.Funcionalidade.Contas
{
	...
	public class ContasServicoTestes
	{
		...
		public void Conta_servico_inserir_deve_funcionar()
		{
            ...
            ContaRegistroCommand contaRegistroCommand = new ContaRegistroCommand();
            cliente.Id = 1;
            conta.Titular = cliente;

            contaRegistroCommand.ClienteId = conta.ClienteId;
            contaRegistroCommand.Estado = conta.Estado;
            contaRegistroCommand.Limite = conta.Limite;
            contaRegistroCommand.NumeroConta = conta.NumeroConta;
			...
			var novaContaId = _servico.Inserir(contaRegistroCommand);
		...
		{
			var conta = ObjectMother.ObtemContaValida();
            ContaRemoveCommand contaRemoveCommand = new ContaRemoveCommand();
            contaRemoveCommand.Id = conta.Id;
			_repositorio.Setup( pr => pr.Deletar( conta.Id ) ).Returns( true );

			var contaRemovida = _servico.Deletar( contaRemoveCommand );
		...
		public void Conta_servico_deletar_id_nao_encontrado_deve_falhar()
		{
			...
			Action action = () => _servico.Deletar(contaRemoveCommand);
		...
		public void Conta_servico_atualizar_deve_funcionar()
		{
            ...
            ContaAtualizarCommand contaAtualizarCommand = new ContaAtualizarCommand();
            contaAtualizarCommand.ClienteId = conta.ClienteId;
            contaAtualizarCommand.Estado = conta.Estado;
            contaAtualizarCommand.Id = conta.Id;
            contaAtualizarCommand.Limite = conta.Limite;
			...
			var contaFoiRemovida = _servico.Atualizar( contaAtualizarCommand );
		...
		public void Conta_servico_atualizar_deve_falhar_por_id_nao_encontrado()
		{
			...
			Action action = () => _servico.Atualizar(contaAtualizarCommand);
