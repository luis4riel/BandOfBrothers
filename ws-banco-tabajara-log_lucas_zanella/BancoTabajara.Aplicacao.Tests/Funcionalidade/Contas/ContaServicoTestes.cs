...
namespace BancoTabajara.Aplicacao.Tests.Funcionalidade.Contas
{
    ...
    public class ContasServicoTestes
    {
        ...
        CommandAtualizarConta _commandAtualizarConta;
        CommandDeletarConta _commandDeletarConta;
        CommandRegistrarConta _commandRegistrarConta;
        ...
        public void Conta_servico_inserir_deve_funcionar()
        {
            ...
            _commandRegistrarConta.ClienteId = cliente.Id;
            ...
            var novaContaId = _servico.Inserir(_commandRegistrarConta);
        ...
        public void Conta_servico_deletar_deve_funcionar()
        {
            ...
            _commandDeletarConta.Id = conta.Id;

            var contaRemovida = _servico.Deletar(_commandDeletarConta);
        ...
        public void Conta_servico_deletar_id_nao_encontrado_deve_falhar()
        {
            ...
            Action action = () => _servico.Deletar(_commandDeletarConta);
        ...
        public void Conta_servico_atualizar_deve_funcionar()
        {
            ...
            _repositorioCliente.Setup(odr => odr.PegarPorId(conta.ClienteId)).Returns(conta.Titular);
            _repositorio.Setup(odr => odr.Atualizar(conta)).Returns(atualizada);

            _commandAtualizarConta.Id = conta.Id;
            _commandAtualizarConta.Limite = conta.Limite;
            _commandAtualizarConta.ClienteId = conta.Titular.Id;
            _commandAtualizarConta.Estado = conta.Estado;

            var contaFoiRemovida = _servico.Atualizar(_commandAtualizarConta);
        ...
        public void Conta_servico_atualizar_deve_falhar_por_id_nao_encontrado()
        {
            ...
            _commandAtualizarConta.Id = 1;

            Action action = () => _servico.Atualizar(_commandAtualizarConta);
