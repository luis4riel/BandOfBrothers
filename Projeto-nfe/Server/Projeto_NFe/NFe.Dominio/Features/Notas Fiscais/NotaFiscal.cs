...
namespace NFe.Dominio.Features.Notas_Fiscais
{
    public class NotaFiscal : Entidade
    {
        ...
        public override void Validar()
        {
            ...
            foreach (var produto in Produtos)
                produto.Validar();
            if ((Emitente.Cnpj.EhValido && Destinatario.Cnpj.EhValido && Emitente.Cnpj.ValorFormatado == Destinatario.Cnpj.ValorFormatado) ||
                (Emitente.Cpf.EhValido && Destinatario.Cpf.EhValido && Emitente.Cpf.ValorFormatado == Destinatario.Cpf.ValorFormatado))
